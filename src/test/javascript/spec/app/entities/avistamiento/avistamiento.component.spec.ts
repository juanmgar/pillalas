...
import { AvistamientoComponent } from 'app/entities/avistamiento/avistamiento.component';
...
describe('Component Tests', () => {
  describe('Avistamiento Management Component', () => {
    let comp: AvistamientoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [AvistamientoComponent],
        providers: [
          {
        ...
        .overrideTemplate(AvistamientoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.avistamientos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
