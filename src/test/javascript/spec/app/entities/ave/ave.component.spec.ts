...
import { AveComponent } from 'app/entities/ave/ave.component';
import { AveService } from 'app/entities/ave/ave.service';
import { Ave } from 'app/shared/model/ave.model';

describe('Component Tests', () => {
  describe('Ave Management Component', () => {
    let comp: AveComponent;
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.aves[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
