...
describe('Service Tests', () => {
  describe('Observatorio Service', () => {
    let injector: TestBed;
    let service: ObservatorioService;
    let httpMock: HttpTestingController;
    let elemDefault: IObservatorio;
    let expectedResult;
    beforeEach(() => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a Observatorio', async () => {
      ...
      it('should update a Observatorio', async () => {
        const returnedFromService = Object.assign(
          {
            nombre: 'BBBBBB',
            latitud: 'BBBBBB',
      ...
      it('should return a list of Observatorio', async () => {
        const returnedFromService = Object.assign(
          {
            nombre: 'BBBBBB',
            latitud: 'BBBBBB',
      ...
      it('should delete a Observatorio', async () => {
