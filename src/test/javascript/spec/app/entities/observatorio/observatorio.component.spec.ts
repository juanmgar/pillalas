...
import { ObservatorioComponent } from 'app/entities/observatorio/observatorio.component';
...
describe('Component Tests', () => {
  describe('Observatorio Management Component', () => {
    let comp: ObservatorioComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ObservatorioComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.observatorios[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
